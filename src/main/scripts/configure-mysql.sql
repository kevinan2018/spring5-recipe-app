## Use to run mysql db docker image, optional if yor are not using a local mysqldb
# docker run --name mysqldb -p 3306:3306 -eMYSQL_ALLOW_EMPTY_PASSWORD=yes -d mysql
...
# % represents any hosts which is necessary for dockers
